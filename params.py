...
def cosmo_par():
    nbody_file_in = "/home/jamesdr/scratch/smallbox/output_00011"
    import re
    import numpy as np
...
def baryon_par():
    par = {
        "Mc": 1e14,     # beta(M,z): critical mass scale
        ...
        "eta": 0.3,      # exponent of total stellar fraction [fstar = Nstar*(Mstar/Mvir)**eta]
        "deta": 0.3,     # exponent of central stellar fraction [fstar = Nstar*(Mstar/Mvir)**(eta+deta)]
